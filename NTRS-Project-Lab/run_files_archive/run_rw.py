...
if __name__ == "__main__":
    ...
    df_forecasts.to_csv(os.path.join(results_dir, "rw_forecasts.csv"), index=False)
    print(f"Random Walk model complete. Results saved to {os.path.join(results_dir, 'rw_forecasts.csv')}")